...
//                            <a href="/edit-expense?id=${expenses[i].id}&title=${expenses[i].title}" class="btn btn-primary">Редактировать</a>
...
//            <a href="/create-expense" class="text-center text-decoration-none">Создать категорию расходов</a>
//        `;
    ...
    createExpenseCard(expense) {
        ...
        cardElement.innerHTML = `
            <div class="card h3 p-3 text-purple-dark">
                ${expense.title}
                <div class="action pt-3">
                    <a href="/edit-income?id=${expense.id}&title=${expense.title}" class="btn btn-primary">Редактировать</a>
